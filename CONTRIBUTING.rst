...
Report bugs at https://github.com/sacadena/coockie-test/issues
...
https://github.com/sacadena/coockie-test/issues.
...
Ready to contribute? Here's how to set up `coockie-test` for local
development. Please note this documentation assumes you already have
`poetry` and `Git` installed and ready to go.

| 1. Fork the `coockie-test` repo on GitHub. 
...
| 2. Clone your fork locally:
   ...
   .. code-block:: bash
        ...
        git clone git@github.com:YOUR_NAME/coockie-test.git
